...
public class PopcornMachine {
    ...
    public PopcornMachine(int x, int y) {
        this.x = x;
        this.y = y;
        updateSprite();
    }
    ...
    private void updateSprite() {
        String basePath = "machines/Popcorn/";
        String stateName = "";

        switch (state) {
            case Constants.MACHINE_EMPTY:
                stateName = "Popcorn Machine Empty";
                break;
            case Constants.MACHINE_REFILL_1:
                stateName = "Popcorn Machine Refill 1";
                break;
            case Constants.MACHINE_REFILL_2:
                stateName = "Popcorn Machine Refill 2";
                break;
            case Constants.MACHINE_FULL:
                stateName = "Popcorn Machine Filled";
                break;
            case Constants.MACHINE_LESS_FULL:
                stateName = "Popcorn Machine LessFilled";
                break;
        }
